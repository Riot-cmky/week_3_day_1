...
print(3/2)
# #modulo
print(7%4) # remainder of two numbers devided
# #powers
print(2**3)
# #get the max and min of a number
print(max(1,2)) # max will get the largest number
print(min(1,2)) # min will get the smallest number
# #round a number
print(round(3.4))
# # absolute value
print(abs(-3)) # absolute value of a number
# absolute value is the distance from 0 to the number (always positive)
# # order of operations
print(2 + 10 * 10 + 3)
...
# #floor method
print(floor(3.7)) # the floor method rounds down
# #ceil method
print(ceil(3.7)) # ceil method rounds down
# #sqrt method
